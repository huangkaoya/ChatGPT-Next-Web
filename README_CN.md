...
> **警告**：请务必将密码的位数设置得足够长，最好 7 位以上，否则[会被爆破](https://github.com/huangkaoya/ChatGPT-Next-Web/issues/518)。
...
[见项目贡献者列表](https://github.com/huangkaoya/ChatGPT-Next-Web/graphs/contributors)
